...
use imie\ComplogBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('imieComplogBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("imieComplogBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('imieComplogBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("imieComplogBundle:Customer:edit.html.twig")
     */
