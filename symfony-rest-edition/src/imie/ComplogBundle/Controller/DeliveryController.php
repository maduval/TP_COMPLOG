...
use imie\ComplogBundle\Form\DeliveryType;
...
class DeliveryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('imieComplogBundle:Delivery')->findAll();
     ...
     * @Method("POST")
     * @Template("imieComplogBundle:Delivery:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('imieComplogBundle:Delivery')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("imieComplogBundle:Delivery:edit.html.twig")
     */
